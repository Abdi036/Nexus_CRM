...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "border-white/15 bg-white/10 text-white grid min-w-40] items-start gap-2 rounded-lg border px-3 py-2 text-xs shadow-xl shadow-emerald-500/20 backdrop-blur",
        className
      )}
    >
