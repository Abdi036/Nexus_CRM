...
exports.createLead = async (req, res, next) => {
  try {
    ...
    // If sales rep creates a lead, assign to them if not specified
    let leadAssignedTo = assignedTo;
    if (req.user.role === "sales_rep" && !leadAssignedTo) {
      leadAssignedTo = req.user.id;
    }
